...
# db = psycopg2.connect("dbname=news", "user=news", "password=news")
##
#      Better: with user and password specified.
# db = psycopg2.connect(database="postgres",
#                                    user=self.user,
#                                    password=self.passwd)
#
#    Better: define a connection string:
...
# conn.cursor will return a cursor object, you can use
#       this cursor to perform queries
#       cursor = conn.cursor()
